...
- [ ] 数据结构与算法课程学习
- [ ] 实现一些基本的数据结构(尤其是RB-Tree，B+树，K-D Tree,哈希等)
- [ ] 将刷题题解整理成电子书发到 github 上
- [ ] OJ 刷完
- [ ] Leetcode等把排名干上去
- [ ] 系统课程刷完
- [ ] OS，Compiler，Database，TCP-IP协议栈各实现一个（也可以有其他项目）
- [ ] 笔记先记录在博客上
- [ ] 随后整理在 github 上
- [ ] 参与一些系统开源项目(MySQL,Linux等)
- [ ] 安全课程刷完
- [ ] 笔记先记录在博客上
- [ ] 随后整理在 github 上
- [ ] 参与一些安全开源项目
...
- [ ] 自己写几个小型系统实践(组成原理，操作系统，编译器，数据库，分布式，网络协议栈，安全方向)
- [ ] 将实现过程记录在博客上，推广自己的博客
